class QuestionSetsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @question_set.save
        format.html { redirect_to @question_set, notice: 'QuestionSet was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @question_set.update(question_set_params)
        format.html { redirect_to @question_set, notice: 'QuestionSet was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to question_sets_url, notice: 'QuestionSet was successfully destroyed.' }
